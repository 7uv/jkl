...
public class ConnectionManager {
	...
	static String m_DBDriver= TradeAppFormVars.getM_DBDriver();
	static String url = TradeAppFormVars.getUrl();
	static String username = TradeAppFormVars.getUsername();
	static String password = TradeAppFormVars.getPassword();
}
